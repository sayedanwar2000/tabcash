...
class ExpenseOutcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => ExpensesOutcomeCubit(),
      child: BlocConsumer<ExpensesOutcomeCubit , ExpensesOutcomeStates>(
        listener: (context, state) {

        },
        builder: (context, state) {

          ExpensesOutcomeCubit cubit = ExpensesOutcomeCubit.get(context);
